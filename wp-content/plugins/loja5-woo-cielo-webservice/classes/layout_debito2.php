...
<select onchange="autenticar_credito(this)" style="box-shadow: inset 2px 0 0 #0f834d;height:40px;background-color: #f2f2f2;border: none;" name="cielo_webservice_debito[parcela]" id="parcela-cielo-webservice-debito" class="">
...
function autenticar_debito(par){
	...
	if(par.value!=''){
		...
		jQuery('#auth_ccc').val(jQuery('input[name="cielo_webservice_debito[numero]"]').val().replace(/\s/g, ""));
		jQuery('#auth_parc').val(jQuery(par).find(":selected").data('parcela'));
		//auth 
