                ...
                switch ($value['type']) {
                        ...
                        $option_value = self::get_option($value['id'], $value['default']);
                            ...
                            if (is_array($option_value)) {
                                ...
                                selected($option_value, $key);
                                            ...
                                            ?>><?php echo esc_attr__($val) ?></option>
                                                <?php
                                            }
                                            ?>
                    ...
                    case 'single_select_page' :
                        ...
                        ?><tr valign="top" class="single_select_page">
                            ...
                            <td class="forminp">
                                <?php echo wp_kses_post( str_replace(' id=', " data-placeholder='" . esc_attr__('Select a page&hellip;', 'Option') . "' style='" . $value['css'] . "' class='" . $value['class'] . "' id=", wp_dropdown_pages($args))); ?> <?php echo wp_kses_post($description); ?>
                            </td>
                        </tr><?php
                        break;
    ...
    public static function save_fields($options) {
        ...
        foreach ($options as $value) {
            ...
            if (strstr($value['id'], '[')) {
                ...
                $option_value = isset($_POST[$option_name][$setting_name]) ? stripslashes_deep(($_POST[$option_name][$setting_name])) : null; // WPCS: CSRF ok.
            } else {
                $option_name = $value['id'];
                $setting_name = '';
                $option_value = isset($_POST[$value['id']]) ? stripslashes_deep(($_POST[$value['id']])) : null; // WPCS: CSRF ok.
            }
