  ...
  public function get_settings( $settings, $current_section ) {
    if ( 'wc-simulador-parcelas' == $current_section ) {
      ...
      $wc_simulador_parcelas_settings = array(
        ...
        array(
          'title'    => __( 'Estilo', 'wc-simulador-parcelas' ),
          'desc'     => __( 'Selecione o estilo de design do site. <a href="https://ajuda.fernandoacosta.net/article/show/131743-modificar-o-estilo-do-plugin" target="_blank">Saiba mais</a>.', 'wc-simulador-parcelas' ),
          'id'       => 'wc_simulador_parcelas_style',
          'class'    => 'wc-enhanced-select',
          'css'      => 'min-width:300px;',
          'default'  => '',
          'type'     => 'select',
          'options'  => wcsp_get_available_styles(),
          'desc_tip' =>  true,
        ),
