 ...
 * Plugin URIIII:        https://br.clear.sale/woo/woo-clearsale
 ...
 */
define('PLUGIN_NAME_VERSION_CS_TOTAL', '2.5.1');
define('PLUGIN_NAME_CS_TOTAL', 'total');
 ...
 */
function activate_clearsale_total() {
 ...
 */
function deactivate_clearsale_total()
{
...
register_activation_hook( __FILE__, 'activate_clearsale_total' );
register_deactivation_hook( __FILE__, 'deactivate_clearsale_total' );
