...
class SiteGround_Migrator {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-siteground-migrator-helper.php';
		...
		$this->helper             = new SiteGround_Migrator_Helper();
	...
	public function siteground_migrator_shutdown_handler() {
		...
		if (
			...
			$this->transfer_service->update_status(
				...
				0,
				$this->helper->get_error_message( $error )
			);
