...
<section class="woocommerce-order-details">
   ...
   <a href=" <?php echo get_post_meta($order_id, 'linkderastreio', true); ?>" target="_blank">
   <button class="" type="button"  style="background-color:#7e4a22; color:white; border-radius:10px; margin-left:35%; margin-bottom:15px;" >  ACOMPANHAR ENTREGA  </button></a>
